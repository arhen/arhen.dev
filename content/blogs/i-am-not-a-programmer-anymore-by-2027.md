...
Yesterday, [Andrej Karpathy tweeted something](https://x.com/karpathy/status/2004607146781278521) that hit different. The idea that "programmers" as we know them might not exist in the traditional sense anymore.

Even [Boris Cherny](https://x.com/bcherny/status/2004626064187031831), the creator of Claude Code, echoed this sentiment, emphasizing how fundamentally the craft is shifting.

<blockquote class="twitter-tweet" data-theme="dark"><p lang="en" dir="ltr">Strongly agree. I built Claude Code, and even I&#39;m surprised by how fast things are moving. The way we write software is fundamentally changing.</p>&mdash; Boris Cherny (@bcherny) <a href="https://twitter.com/bcherny/status/2004626064187031831?ref_src=twsrc%5Etfw">December 2025</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
Here in Indonesia where I live, [the creative industry is facing mass layoffs](https://en.tempo.co/read/2026761/indonesias-creative-industry-faces-mass-layoffs-in-2025-as-ai-overtakes) as AI overtakes traditional roles. One DPR member reported that nearly 60% of employees at her friend's agency company were laid off in 2025, replaced by AI. Sixty percent! That's not a trim, that's a massacre.
...
Back in May 2023, I wrote a post about [Key Points when Learning Large Language Models](/blogs/key-points-when-learning-large-language-models-llms/). At that time, I was genuinely excited and ... dumb :)
...
Let's take a look at this chart from [@erikbryn's research paper](https://x.com/erikbryn):

{{< img src="images/uploads/headcount-by-age-group.png" alt="Headcount Over Time by Age Group - Software Developers (Normalized)" >}}
...
Meanwhile, look at the purple and brown lines: **Mid-Career 2 (41-49)** and **Senior (50+)** are actually _growing_. Experience, context, and architectural knowledge are becoming more valuable, not less. These are the people who know _what_ to build and _why_ — skills that AI can't easily replicate. Yet.
